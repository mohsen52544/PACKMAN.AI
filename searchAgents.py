...
class PositionSearchProblem(search.SearchProblem):
    ...
    def getSuccessors(self, state):
        """
        Given a state, return a list of successors and the actions/costs
        needed to reach them from the current state.
        """
        successors = []
        # Your code here to populate the successors list
